...
<head>
    ...
    <title>${empty room ? '新增' : '编辑'}会议室 - 管理员面板</title>
...
<div class="bg-white p-6 md:p-8 rounded-lg shadow-xl max-w-2xl mx-auto content-card-enhanced relative z-0">
    ...
    <form action="${pageContext.request.contextPath}/admin" method="post" class="space-y-6">
        ...
        <div>
            <label for="roomName" class="block text-sm font-medium text-gray-700 mb-1">会议室名称:</label>
            <input type="text" id="roomName" name="roomName" value="${room.roomName}" required
                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
        <div>
            <label for="locationId" class="block text-sm font-medium text-gray-700 mb-1">位置:</label>
        ...
        <div>
            <label for="capacity" class="block text-sm font-medium text-gray-700 mb-1">容量:</label>
            <input type="number" id="capacity" name="capacity" value="${room.capacity}" required min="1"
                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
        <div>
            <label for="amenities" class="block text-sm font-medium text-gray-700 mb-1">设施 (逗号分隔):</label>
        ...
        <div class="flex justify-end space-x-4 pt-4">
            ...
            <a href="${pageContext.request.contextPath}/admin?action=manageRooms" class="btn-cancel-enhanced px-6 py-2 rounded-lg font-bold">取消</a>
        </div>
    </form>
</div>
